		...
		FIR.checkForUpdateInFIR(firToken, new VersionCheckCallback() {
			...
			public void onSuccess(String versionJson) {
				...
				try {
					...
					final String direct_install_url = jsonObject
							.getString("direct_install_url");
			...
			public void onFail(Exception exception) {
				if (!isAuto) {
					ToastUtil.showToast(context, "网络慢  请重试一次",
							Toast.LENGTH_SHORT);
				}
			}
